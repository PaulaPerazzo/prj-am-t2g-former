...
def compute_auc_ovo(y_true, probs):
    """Cálculo robusto do AUC OVO com alinhamento automático das classes."""
...
def evaluate_split(model, X, y):
    ...
    # ajustar caso modelo remova classes
...
if __name__ == "__main__":
    ...
    df.to_csv("results/final_autosklearn_results_bal.csv", index=False)

    print("Resultados salvos em results/final_autosklearn_results_bal.csv")
